...
export default function ProductClient({ id, initialProduct }: ProductClientProps) {
  ...
  useEffect(() => {
    let active = true
    ;(async () => {
      // If we already have initialProduct, we can skip initial fetch or do it to sync
    ...
    // Log view even if initialProduct is provided
    if (initialProduct && id) {
        logAdView(Number(id)).catch(() => {});
    }
    ...
    <div>
      ...
      <main className="max-w-[1200px] mx-auto mt-6 px-4 sm:px-6"> 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6 items-start">
            ...
            <div className="rounded-md bg-white border-2 border-orange-200 p-4">
              ...
              <div className="mt-4 space-y-2">
                ...
                <button 
                  ...
                  className="w-full flex items-center justify-center bg-white text-gray-400 border border-gray-200 py-2.5 rounded-md font-bold transition-all hover:bg-red-50 hover:text-red-500 hover:border-red-100 shadow-sm"
                >
            ...
            <div className="rounded-md border-2 border-orange-200 bg-white p-4">
              ...
              <div className="flex items-center gap-2">
                <input 
                  ...
                  className="flex-1 bg-gray-50 border border-gray-200 rounded-md py-2 px-3 text-[10px] sm:text-xs text-gray-500 outline-none"
                />
                <button 
          ...
          {/* Reviews and Safety sections continue below on desktop */}
