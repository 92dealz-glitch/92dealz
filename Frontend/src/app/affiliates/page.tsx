    ...
    <div className="min-h-screen flex flex-col bg-gray-50 text-gray-800">
      ...
      <main className="flex-grow w-full max-w-[1200px] mx-auto px-6 py-12 sm:py-20">
        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
          <p>
            Partner with <strong>234Deals</strong> and earn rewards by promoting our marketplace! Our affiliate program is designed to mutually benefit content creators, influencers, and community leaders.
          </p>
          ...
          <p className="mt-6">
            If you have an engaged audience and a passion for e-commerce, we would love to have you on board. For more information or to apply, please contact us at <a href="mailto:234deals@gmail.com" className="text-orange-500 hover:underline">234deals@gmail.com</a>.
          </p>
        </div>
      </main>
      <Footer />
