        ...
        <div className="bg-white rounded-lg border border-zinc-200 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] overflow-hidden p-8 lg:p-12 animate-in fade-in duration-500 max-w-2xl">
            ...
            <form className="space-y-8">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <input type="text" placeholder="Enter new phone number" className="border border-zinc-200 rounded-lg p-4 text-zinc-900 font-bold focus:outline-none focus:border-[#E85A28] transition-colors" />
                </div>
