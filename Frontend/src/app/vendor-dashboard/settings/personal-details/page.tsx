        ...
        <div className="bg-white rounded-lg border border-zinc-200 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07)] overflow-hidden p-8 lg:p-12 animate-in fade-in duration-500">
            ...
            <div className="max-w-3xl">
                <div className="mb-12 relative inline-block">
                    ...
                    <label className="absolute bottom-0 right-0 bg-[#708238] text-white p-2.5 rounded-full border-4 border-white shadow-md hover:bg-[#708238] transition-all cursor-pointer">
                        <CameraIcon />
                ...
                <form onSubmit={handleSave} className="space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" name="name" value={profile.name} onChange={handleChange} required className="border border-zinc-200 rounded-lg p-4 text-zinc-900 font-bold focus:outline-none focus:border-[#708238] transition-colors" placeholder="Enter full name" />
                        </div>
                        <div className="flex flex-col gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" name="phone" value={profile.phone} onChange={handleChange} className="border border-zinc-200 rounded-lg p-4 text-zinc-900 font-bold focus:outline-none focus:border-[#708238] transition-colors" placeholder="+234 8100909 000" />
                        </div>
                        <div className="flex flex-col gap-2">
                            <label className="text-black font-black text-[15px]">Business Name</label>
                            <input type="text" name="businessName" value={profile.businessName} onChange={handleChange} className="border border-zinc-200 rounded-lg p-4 text-zinc-900 font-bold focus:outline-none focus:border-[#708238] transition-colors" placeholder="e.g. Adaeze Fashion House" />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="relative">
                                <select name="businessCategory" value={profile.businessCategory} onChange={handleChange} className="appearance-none w-full border border-zinc-200 rounded-lg p-4 text-zinc-900 font-bold focus:outline-none focus:border-[#708238] transition-colors bg-white">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <input type="text" name="businessAddress" value={profile.businessAddress} onChange={handleChange} className="border border-zinc-200 rounded-lg p-4 text-zinc-900 font-bold focus:outline-none focus:border-[#708238] transition-colors" placeholder="e.g. 14 Broad Street, Lagos" />
                        </div>
                    </div>
                    ...
                    <div className="flex justify-start pt-8">
                        <button type="submit" disabled={saving} className="bg-[#708238] hover:bg-[#708238] disabled:opacity-50 text-white font-black py-4 px-16 rounded-xl transition-all shadow-lg shadow-[#E9E0D4] min-w-[240px]">
