...
function StatusBadge({ status }: { status: string }) {
  const styles = {
    PENDING: "bg-[#E9E0D4] text-[#708238] border-[#E9E0D4]/30",
    APPROVED: "bg-green-50 text-[#708238] border-[#E9E0D4]",
    ...
    <div className="p-6 lg:p-10 space-y-8 max-w-[1600px] mx-auto animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-10 pr-4 py-3 bg-white border border-zinc-200 rounded-xl w-full md:w-[320px] focus:outline-none focus:border-[#708238] transition-all font-bold"
            value={searchQuery}
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-20 gap-4">
          <div className="w-12 h-12 border-4 border-[#708238] border-t-transparent rounded-full animate-spin" />
                  ...
                  <tr key={sub.id} className="hover:bg-zinc-50/50 transition-colors group">
                    <td className="px-6 py-5">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-black text-black hover:text-[#708238] transition-colors cursor-pointer" onClick={() => setSelectedSubmission(sub)}>
                            {sub.title}
                          </p>
              ...
              <div className="flex justify-between items-start gap-4">
                <div>
                  ...
                  <div className="flex items-center gap-2 text-zinc-500 font-bold text-sm mt-1">
                    <MapPin size={14} className="text-[#708238]" />
                    {selectedSubmission.city}, {selectedSubmission.state}
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-[#708238] text-2xl font-black">G�{selectedSubmission.price.toLocaleString()}</div>
              ...
              {selectedSubmission.status === "PENDING" && (
                <div className="flex gap-4 pt-4">
                  ...
                  <button 
                    ...
                    className="flex-1 bg-[#708238] hover:bg-[#708238] text-white font-black py-4 rounded-2xl transition-all shadow-lg shadow-[#E9E0D4] disabled:opacity-50"
                  >
