      ...
      <div className="max-w-[1200px] mx-auto mt-8 px-4 sm:px-6">
        <div className="relative bg-white rounded-lg overflow-hidden">
          <div className="flex flex-row items-center justify-center gap-x-0">
            ...
            {/* Text block */}
            <div className="max-w-[65%] py-4 pl-4 pr-0 sm:p-4 lg:pl-0 lg:pr-0 z-10 flex flex-col justify-center items-start">
            ...
            <div className="flex-shrink-0 p-0 sm:p-4 flex items-center justify-center">
              <div className="relative w-[175px] xs:w-[205px] sm:w-[280px] md:w-[320px] aspect-square">
                <Image
